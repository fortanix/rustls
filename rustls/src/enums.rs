...
impl CipherSuite {
    // TODO (arash) may not be needed
    /// Return the ruslts-supported `KeyExchangeAlgorithm` of the given cipher suite
    pub fn key_exchange_algorithm(&self) -> Option<KeyExchangeAlgorithm> {
        use CipherSuite::*;
        match self {
            TLS13_CHACHA20_POLY1305_SHA256 => Some(KeyExchangeAlgorithm::ECDHE),

            TLS13_AES_128_GCM_SHA256
            | TLS13_AES_256_GCM_SHA384
            | TLS13_AES_128_CCM_SHA256
            | TLS13_AES_128_CCM_8_SHA256 => Some(KeyExchangeAlgorithm::ECDHE),
            ...
            | TLS_ECDHE_PSK_WITH_CHACHA20_POLY1305_SHA256 => Some(KeyExchangeAlgorithm::ECDHE),
            ...
            | TLS_DHE_PSK_WITH_CHACHA20_POLY1305_SHA256 => Some(KeyExchangeAlgorithm::DHE),
